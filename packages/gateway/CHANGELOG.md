...
- 8bf8ecb: Add information-flow control — governance for the data, not just the caller.
...
- 94c2e36: Detect "enable / activate / turn on developer mode" jailbreak phrasing.
